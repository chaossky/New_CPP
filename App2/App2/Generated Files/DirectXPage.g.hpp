...
void ::App2::DirectXPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    ...
    case 3:
        {
            ...
            (safe_cast<::Windows::UI::Xaml::Controls::AppBarButton^>(element3))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::App2::DirectXPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::App2::DirectXPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
